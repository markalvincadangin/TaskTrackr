...
$project_query = "SELECT title, group_id, created_by FROM Projects WHERE project_id = ?";
...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1 p-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            <h2 class="mb-0">Tasks for Project: <?= htmlspecialchars($project_title) ?></h2>
                                ...
                                <?php while ($task = $task_result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <!-- Edit Button -->
                                            <a href="../actions/edit_task.php?task_id=<?= $task['task_id'] ?>&project_id=<?= $project_id ?>" class="btn btn-warning btn-sm mb-1" title="Edit">
